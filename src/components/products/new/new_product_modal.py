...
class NewProductModal(tk.Toplevel):
    def __init__(self, parent, on_submit):
        ...
        for i, field in enumerate(fields):
            ...
            entry.grid(row=i*2+1, column=0, padx=10, pady=(0, 10), sticky="ew")  # ocupa toda a largura
    ...
    def _save(self):
        ...
        for field, entry in self.entries.items():
            ...
            if value == "":
                entry.configure(background="#ffcccc")  # vermelho claro
                errors = True
